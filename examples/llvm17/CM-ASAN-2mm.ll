; ModuleID = 'examples/llvm17/ASAN-2mm.ll'
...
entry:
  ...
  %zyarg_ = inttoptr i64 %0 to ptr
  %zybc_ = bitcast ptr %zyarg_ to ptr
  %zyarg_1 = inttoptr i64 %2 to ptr
  %zybc_2 = bitcast ptr %zyarg_1 to ptr
  %zyarg_3 = inttoptr i64 %4 to ptr
  %zybc_4 = bitcast ptr %zyarg_3 to ptr
  %zyarg_5 = inttoptr i64 %6 to ptr
  %zybc_6 = bitcast ptr %zyarg_5 to ptr
  %zyarg_7 = inttoptr i64 %8 to ptr
  %zybc_8 = bitcast ptr %zyarg_7 to ptr
  call void @_Z5spawnjPFvPvS_S_S_S_ES_S_S_S_S_(i32 -745346616, ptr @_spawn_loop_free_func_0_0, ptr %zybc_, ptr %zybc_2, ptr %zybc_4, ptr %zybc_6, ptr %zybc_8)
...
print_array.exit:                                 ; preds = %for.inc8.i101, %if.then
  %zyarg_9 = inttoptr i64 ptrtoint (ptr @stderr to i64) to ptr
  %zybc_10 = bitcast ptr %zyarg_9 to ptr
  call void @_Z5spawnjPFvPvES_(i32 -1126012559, ptr @_spawn_loop_free_func_1_0, ptr %zybc_10)
...
if.end:                                           ; preds = %print_array.exit, %kernel_2mm.exit
  ...
  call void @_Z4joinj(i32 -745346616)
  call void @_Z4joinj(i32 -1126012559)
  ret i32 0
}
...
declare void @__catamaran_async_run_i32(ptr, i32)

define internal void @_spawn_loop_free_func_0_0(ptr %0, ptr %1, ptr %2, ptr %3, ptr %4) {
entry:
  %5 = bitcast ptr %0 to ptr
  %zt_ = ptrtoint ptr %5 to i64
  call void @__asan_load8(i64 %zt_)
  %6 = bitcast ptr %1 to ptr
  %zt_1 = ptrtoint ptr %6 to i64
  call void @__asan_load8(i64 %zt_1)
  %7 = bitcast ptr %2 to ptr
  %zt_2 = ptrtoint ptr %7 to i64
  call void @__asan_load8(i64 %zt_2)
  %8 = bitcast ptr %3 to ptr
  %zt_3 = ptrtoint ptr %8 to i64
  call void @__asan_load8(i64 %zt_3)
  %9 = bitcast ptr %4 to ptr
  %zt_4 = ptrtoint ptr %9 to i64
  call void @__asan_load8(i64 %zt_4)
  ret void
}

declare void @_Z5spawnjPFvPvS_S_S_S_ES_S_S_S_S_(i32, ptr, ptr, ptr, ptr, ptr, ptr)

define internal void @_spawn_loop_free_func_1_0(ptr %0) {
entry:
  %1 = bitcast ptr %0 to ptr
  %zt_ = ptrtoint ptr %1 to i64
  call void @__asan_load8(i64 %zt_)
  ret void
}

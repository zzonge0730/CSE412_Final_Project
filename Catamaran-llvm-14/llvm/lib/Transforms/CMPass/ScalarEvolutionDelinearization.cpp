...
void ScalarEvolutionDelinearization::delinearize(
...
#if 0
  // LLVM 14: 1단계 - collectParametricTerms와 findArrayDimensions가 제거됨
  // TODO: 2단계에서 LLVM 14의 새로운 delinearization API로 대체 필요
  ...
  // TODO: 2단계에서 LLVM 14의 새로운 delinearization API로 대체 필요
  (void)SE; (void)Expr; (void)Subscripts; (void)Sizes; (void)ElementSize; // unused parameter warning 방지
  return;
#endif

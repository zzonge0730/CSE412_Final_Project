...
// LLVM 14: PDGAnalysis는 현재 비활성화되어 있으므로, 이 파일도 조건부 컴파일
#if 0
#include "llvm/Pass.h"
...
void PDGAnalysis::constructEdgesFromAliasesForFunction(PDG *pdg, Function &F) {
#if 0
    // LLVM 14: 1단계 - 레거시 PassManager에서 새 PassManager의 Analysis 사용 불가
    // TODO: 2단계에서 새 PassManager로 전환 필요
    ...
    // TODO: 2단계에서 새 PassManager로 전환 필요
    (void)pdg; (void)F; // unused parameter warning 방지
#endif
}
...
// LLVM 14: AliasResult는 llvm namespace에 있음
llvm::AliasResult PDGAnalysis::doTheyAlias (PDG *pdg, Function &F, AliasAnalysis &AA, Value * instI, Value * instJ) {
    //query the llvm alias analysis
...
#endif // #if 0 - LLVM 14: PDGAnalysis 비활성화
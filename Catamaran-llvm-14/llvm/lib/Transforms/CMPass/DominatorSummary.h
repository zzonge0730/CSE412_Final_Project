...
// PostDominatorTree를 사용하므로 완전한 타입이 필요
...
// LLVM 14: PostDominatorTree는 DominatorTreeBase<BasicBlock, true>의 typedef
// llvm/IR/Dominators.h에 정의되어 있음
using PostDominatorTree = DominatorTreeBase<BasicBlock, true>;
